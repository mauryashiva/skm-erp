...
export default function AccountTypePage() {
  ...
  const canCreate = isMounted && currentIsHoActive && hasPermission('parameters.account_type.create');
  const canEdit   = isMounted && currentIsHoActive && hasPermission('parameters.account_type.edit');
  const canDelete = isMounted && currentIsHoActive && hasPermission('parameters.account_type.delete');
